...
## Relationship to the Governance Lifecycle

Canon entries are typically created during [GOV-R-003 Canon Sync](canon-sync.md). After implementation work governed by [GOV-R-002](implementation-process.md) is merged, the canon sync agent extracts reusable architectural learnings and follows this review process to promote them into the canon.
